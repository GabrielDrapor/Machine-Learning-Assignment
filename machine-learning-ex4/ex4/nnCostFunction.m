...
for i=1:m
    ...
    J = J + (sum((b.*log(a3)+(1-b).*log(1-a3))));
    
    delta_3 = a3 - b ; %10*1
    
    delta_2 = (Theta2)'*delta_3;
    
    delta_2 = delta_2(2:end).*sigmoidGradient(z2);    %25*1
...
Theta1_grad = [Theta1_grad(:,1) Theta1_grad(:,2:end)+regu1(:,2:end)] ;

regu2 = (lambda/m) .* Theta2;
Theta2_grad = [Theta2_grad(:,1) Theta2_grad(:,2:end)+regu2(:,2:end)] ;
